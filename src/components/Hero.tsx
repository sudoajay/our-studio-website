  ...
  return (
    <section className="hero">
      <Fade direction="up" triggerOnce={true}>
        <div className="w-full lg:w-5/6 xl:pl-12 sm:pr-2 mt-8 ">
          ...
          <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
            We provide developers & designers using latest technologies to help you scale up your
            business.
          </p>
      ...
      <Fade direction="up" triggerOnce={true}>
        <div className="flex pt-5 w-full justify-center items-center order-first md:w-full lg:order-last ">
