...
const AllPortfolio: React.FC<AllPortfolioProps> = ({ data }) => {
    ...
    <Fade direction="up" triggerOnce={true}>
      <section className="container mx-auto">
        <Tabs className="flex flex-col px-4">
          ...
          <TabPanel>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 xl:gap-8 justify-items-center">
              {mobile.map((item, index) => (
                <Fade direction="up" triggerOnce={true} key={item.id} delay={500 * index}>
