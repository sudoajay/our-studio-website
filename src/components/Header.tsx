  ...
  return (
    <header className="header">
      <Fade triggerOnce={true}>
        ...
        <ul className="hidden text-theme-blue tracking-widest items-center lg:flex flex-row gap-5 mt-0">
          <li>
            <Button
              className={`${
                path === '/' ? 'active-link' : ''
      ...
      <Transition
        ...
        leaveTo="opacity-0"
      >
        <ul className="z-50 flex flex-col text-theme-blue tracking-widest my-16 absolute bg-white w-full border-b-2 border-gray-300 lg:hidden">
